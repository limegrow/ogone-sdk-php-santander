...
class DirectLinkPaymentRequest extends AbstractPaymentRequest
{
    ...
    const TEST = "https://test-secure.tpvecommerce.es/ncol/test/orderdirect_utf8.asp";
    const PRODUCTION = "https://secure.tpvecommerce.es/ncol/prod/orderdirect_utf8.asp";

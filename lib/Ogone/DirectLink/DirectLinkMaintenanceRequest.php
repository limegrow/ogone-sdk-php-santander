...
class DirectLinkMaintenanceRequest extends AbstractDirectLinkRequest
{
    ...
    const TEST = "https://test-secure.tpvecommerce.es/ncol/test/maintenancedirect_utf8.asp";
    const PRODUCTION = "https://secure.tpvecommerce.es/ncol/prod/maintenancedirect_utf8.asp";

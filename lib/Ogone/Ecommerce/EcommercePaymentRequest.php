...
class EcommercePaymentRequest extends AbstractPaymentRequest
{
    ...
    const TEST = "https://test-secure.tpvecommerce.es/ncol/test/orderstandard_utf8.asp";
    const PRODUCTION = "https://secure.tpvecommerce.es/ncol/prod/orderstandard_utf8.asp";
